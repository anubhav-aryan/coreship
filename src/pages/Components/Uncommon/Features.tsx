      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 justify-center">
        ...
        <div className="flex bg-[#d9d9d9] rounded-[25px] py-4 px-4 mb-8">
          ...
          <div className="w-1/2">
            ...
            <p className="text-sm md:text-lg lg:text-xl text-gray-800">
              You will acquire the knowledge of industry working and experience
        ...
        <div className="flex bg-[#d9d9d9] rounded-[25px] py-4 px-4 mb-8">
          <div className="w-1/2">
            <h2 className="text-xl md:text-2xl lg:text-3xl text-pink-400 text-center font-bold mb-4">
              Guided Projects and{" "}
              <span className="text-blue-900">Assignments</span>
            </h2>
            <p className="text-sm md:text-lg lg:text-xl text-center text-gray-800">
        ...
        <div className="flex bg-[#d9d9d9] rounded-[25px] py-4 px-4 mb-8">
          ...
          <div className="w-1/2">
            ...
            <p className="text-sm md:text-lg lg:text-xl text-gray-800 mt-4">
        ...
        <div className="flex bg-[#d9d9d9] rounded-[25px] py-4 px-4 mb-8">
          ...
          <div className="w-1/2 pl-4">
            <img
              ...
              alt="Feature 3"
              className="w-full h-auto relative transform scale-150"
            />
          </div>
        </div>
      </div>
