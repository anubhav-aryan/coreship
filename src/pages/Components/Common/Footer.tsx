    ...
    <footer className="p-4 sm:p-6 dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 flex flex-col">
            <a href="/" className="flex items-center">
              <img src="/logocoreship.png" className="mr-3 h-16" alt="FlowBite Logo" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CORESHIP</span>
            </a>
            <div className="text-white font-bold pt-4">
              <p>We are dedicated to empowering college students  <br/> 
              with the knowledge and skills they need to excel in the digital world.</p>
            </div>
          </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-200 font-semibold">© 2023 <a href="" className="hover:underline">Coreship™</a>. All Rights Reserved.</span>
