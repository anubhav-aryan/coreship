  ...
  return (
    <div className="top-8">
      <nav className="bg-gray-900 w-full z-20 left-0 pb-16">
        <div className="w-full flex flex-wrap items-center justify-around pl-40 pr-40 mx-auto p-4">
          <Link href="/aboutus">
            <Image src="/logocoreship.png" width={100} height={100} alt="" />
          </Link>
          <div className="flex md:order-2 items-center"> {/* Wrap buttons in a flex container */}
            <Link href="/#courses">
              <button
                type="button"
